...
def icic_bank_statement_main(pdf_file):
    ...
    formate_json["Top_Transactions_Top_10_Credit_Transaction"] = [top_transactions_credited]
    formate_json["Top_Transactions_Top_10_Debit_Transaction"] = [top_transactions_debited]
    formate_json["Top_Transactions_Top_10_Monthly_Transaction"] = month_top_10_transc
